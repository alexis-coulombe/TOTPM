  ...
  $(function() {
    ...
    if ($('#sales-statistics-overview').length) {
      var salesChartCanvas = $('#sales-statistics-overview').
          get(0).
          getContext('2d');
      var gradientStrokeFill_1 = salesChartCanvas.createLinearGradient(0, 0, 0,
          450);
      gradientStrokeFill_1.addColorStop(1, 'rgba(255,255,255, 0.0)');
      gradientStrokeFill_1.addColorStop(0, 'rgba(102,78,235, 0.2)');
      var gradientStrokeFill_2 = salesChartCanvas.createLinearGradient(0, 0, 0,
          400);
      ...
      document.getElementById(
          'sales-statistics-legend').innerHTML = salesChart.generateLegend();
    ...
    if ($('#net-profit').length) {
      ...
      document.getElementById(
          'net-profit-legend').innerHTML = radarChart.generateLegend();
    }
    ...
    if ($('#stats-line-graph-1').length) {
      ...
      var gradientStrokeFill_1 = lineChartCanvas.createLinearGradient(0, 0, 0,
          50);
